...
STATE_SOURCES = {
    ...
    "AZ": {
        "url": "https://services1.arcgis.com/jRaNrRMBX8tDaTpq/arcgis/rest/services/Child_Care_Facilities/FeatureServer/0/query?where=1%3D1&outFields=*&f=csv",
        "format": "csv",
        "source": "AZ DES",
        "note": "Arizona DES licensed child care facilities via ArcGIS open data",
        "local": "data/raw/ece_AZ.csv",
    },
    "CT": {
        "url": "https://data.ct.gov/api/views/xgxi-rfgt/rows.csv?accessType=DOWNLOAD",
        "format": "csv",
        "source": "CT OEC",
        "note": "Connecticut OEC licensed child care programs",
        "local": "data/raw/ece_CT.csv",
    },
    "DC": {
        "url": "https://opendata.dc.gov/api/explore/v2.1/catalog/datasets/child_care_providers/exports/csv?lang=en&timezone=America%2FNew_York&use_labels=true&delimiter=%2C",
        "format": "csv",
        "source": "DC OSSE",
        "note": "DC OSSE licensed child care providers via DC Open Data",
        "local": "data/raw/ece_DC.csv",
    },
    "HI": {
        "url": "https://data.hawaii.gov/api/views/fvka-exu2/rows.csv?accessType=DOWNLOAD",
        "format": "csv",
        "source": "HI DHS",
        "note": "Hawaii DHS licensed child care facilities",
        "local": "data/raw/ece_HI.csv",
    },
    "IN": {
        "url": "https://data.in.gov/api/views/r9mn-wp9e/rows.csv?accessType=DOWNLOAD",
        "format": "csv",
        "source": "IN FSSA",
        "note": "Indiana FSSA licensed child care providers",
        "local": "data/raw/ece_IN.csv",
    },
    "LA": {
        "url": "https://data.louisiana.gov/api/views/fqfp-jnj7/rows.csv?accessType=DOWNLOAD",
        "format": "csv",
        "source": "LA DCFS",
        "note": "Louisiana DCFS licensed child care facilities",
        "local": "data/raw/ece_LA.csv",
    },
    "MA": {
        "url": "https://data.mass.gov/api/views/nkp5-apyb/rows.csv?accessType=DOWNLOAD",
        "format": "csv",
        "source": "MA EEC",
